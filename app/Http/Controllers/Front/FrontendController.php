...
class FrontendController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $currentLang->menus->menus ?? '[]';
        $data['langs'] = Language::all();
        $data['currentLang'] = $currentLang;
        $data['popups'] = Popup::query()->where('language_id', $lang_id)->where('status', 1)->orderBy('serial_number', 'ASC')->get();
    ...
    public function users(Request $request)
    {
        ...
        $data['langs'] = Language::all();
        $data['currentLang'] = $currentLang;
        $data['popups'] = Popup::query()->where('language_id', $currentLang->id)->where('status', 1)->orderBy('serial_number', 'ASC')->get();
    ...
    public function pricing(Request $request)
    {
        ...
        $allPfeatures = $data['be']->package_features ?? "[]";
        $data['allPfeatures'] = json_decode($allPfeatures, true);
    ...
    public function blogDetails($slug, $id)
    {
        ...
        $data['bcats'] = Bcategory::query()
            ...
            ->orderBy('serial_number', 'ASC')
            ->withCount([
                'countBlogNumber as blogs_count' => function ($query) use ($lang_id) {
