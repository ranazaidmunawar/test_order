...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user-front.client.dashboard', $data);
    }
    ...
    public function profile()
    {
        ...
        return view('user-front.client.profile', $data);
    }
    ...
    public function profileUpdate(Request $request)
    {
        ...
        if ($request->hasFile('photo')) {
            $input['photo'] = Uploader::update_picture(Constant::WEBSITE_CUSTOMER_IMAGE, $request->file('photo'), $data->photo, $user->id);
        }
        $data->update($input);
    ...
    public function resetForm()
    {
        ...
        return view('user-front.client.reset', $data);
    }
    ...
    public function shippingDetails()
    {
        ...
        return view('user-front.client.shipping_details', $data);
    }
    ...
    public function shippingUpdate(Request $request)
    {
        ...
        Auth::guard('client')->user()->update($request->all());
    ...
    public function billingDetails()
    {
        ...
        return view('user-front.client.billing_details', $data);
    }
