...
<head>
    ...
    <style>
        /* CRITICAL: Force Scroll-To-Top button to be dark green */
...
<body class="{{ $activeTheme == 'bakery' ? 'theme-dark' : '' }} theme-{{ $userBs->theme }}">
    ...
    @endif
        ...
        @if ($userBs->preloader_status == 1)
            <div id="preloader">
                <div class="loader revolve">
                    <img src="{{ Uploader::getImageUrl(Constant::WEBSITE_PRELOADER, $userBs->preloader, $userBs) }}" alt="">
                </div>
            </div>
        @endif
        ...
        <!-- @if (!request()->routeIs('user.front.cart') && !request()->routeIs('user.product.front.checkout') && !request()->routeIs('user.front.product.checkout'))
        <div id="WAButton"></div>
    @endif -->
        <!-- whatsapp button end-->
        ...
        {{-- whatsapp init code --}}
        @if ($userBs->is_whatsapp == 1 && !request()->routeIs('user.front.cart') && !request()->routeIs('user.product.front.checkout') && !request()->routeIs('user.front.product.checkout'))
            <script type="text/javascript">
                "use strict";
