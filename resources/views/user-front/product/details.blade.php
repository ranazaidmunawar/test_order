            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="shop-content pt-60">
                        ...
                        @if ($product->category)
                            <p class="mt-2">
                                <span class="category-text">{{ $keywords['Category'] ?? __('Category') }} :</span>
                                <a class="category-name cursor-pointer"
                                ...
                                @endphp
                                @if ($subcategory)
                                    <span class="subcategory-text">{{ $keywords['Subcategory'] ?? __('Subcategory') }} :</span>
                                    <a href="{{ route('user.front.items', [getParam(), 'category_id' => $product->category->id, 'subcategory_id' => $subcategory->id]) }}"
                                        class="cursor-pointer subcategory-name">{{ convertUtf8($subcategory->name) }}
                                    </a>
                                @endif
                            </p>
                        @endif
